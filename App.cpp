...
App::App()
{
    ...
    std::cout << "\n --- *** SECRET SANTA MK II *** ---\n Type \"help\" to show command list. Pass an empty line, or "
    ...
    switch (hash(&token[0]))
    {
        case hash("help"):
            std::cout << ">add NAME\n -add a participant to the contest, each one must have a uniqe NAME\n>set prize "
                         ...
                         "deadline YEAR/MONTH/DAY (date has to be all numeric with slashes)\n>prize\n -show the "
                         "current prize\n>deadline\n -show the current deadline\n>find NAME\n -show if the NAME is a "
                         "participant\n>participants\n -show the lists of participants\n>winners\n -show the list of "
                         "winners\n>roll\n -randomly choose a set amount of winners from participants\n>remove NUMBER "
                         "or remove NAME\n -remove a participant from the contest by his NAME or his NUMBER on the "
                         "list\n>clear\n -reset the contest\n>quit\n";
            break;
        ...
        case hash("participants"): contest->showParticipants(); break;

        case hash("winners"): contest->showWinners(); break;

        case hash("roll"): contest->rollWinners(); break;

        case hash("deadline"): contest->showDeadline(); break;

        case hash("prize"): contest->showPrize(); break;
        ...
        case hash("clear"): contest->clear(); break;

        case hash("quit"): return 0;
